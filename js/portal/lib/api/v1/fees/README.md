# Bitcoin Fees Prediction API

The Bitcoin Fees Prediction API is used by the Portal Client to enable users to make informed choices with regards to the time their Bitcoin transactions will spend waiting in the Mempool.

As of this writing, this API is powered by the Bitcoin Fees API provided by Earn.com. This may change in the future.
...
Returns the recommended fees to ensure a transaction makes it into the blockchain within a reasonable period of time, namely:
...
```
$ curl -X GET http://localhost/api/v1/fees/recommended
{
  "fastestFee": 102,
  "halfHourFee": 102,
  "hourFee": 88
...
```
$ curl -X GET http://localhost/api/v1/fees/list
{
  "fees": [
    {
      "minFee": 0,
